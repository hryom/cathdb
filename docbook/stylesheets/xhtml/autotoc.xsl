...
<xsl:template name="division.toc">
  ...
  <xsl:call-template name="make.toc">
    ...
    <xsl:with-param name="nodes" select="d:part|d:reference                                          |d:preface|d:chapter|d:appendix                                          |d:article                                          |d:topic                                          |d:bibliography|d:glossary|d:index                                          |d:refentry                                          |d:bridgehead[$bridgehead.in.toc != 0]                                          |d:division"/>
...
<xsl:template match="d:part|d:reference" mode="toc">
  ...
  <xsl:call-template name="subtoc">
    <xsl:with-param name="toc-context" select="$toc-context"/>
    <xsl:with-param name="nodes" select="d:appendix|d:chapter|d:article|d:topic                                          |d:index|d:glossary|d:bibliography                                          |d:preface|d:reference|d:refentry                                          |d:bridgehead[$bridgehead.in.toc != 0]                                          |d:division"/>
  </xsl:call-template>
</xsl:template>
