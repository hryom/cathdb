<?xml version="1.0" encoding="ASCII"?><!--This file was created automatically by html2xhtml--><!--from the HTML stylesheets.--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="d" version="1.0">
  ...
  <xsl:template match="d:division/d:docinfo"/>
  <xsl:template match="d:division/d:divisioninfo"/>
  <xsl:template match="d:division/d:info"/>
  <xsl:template match="d:division/d:title"/>
  <xsl:template match="d:division/d:titleabbrev"/>
  <xsl:template match="d:division/d:subtitle"/>
  ...
  <xsl:template match="d:divisionintro/d:title"/>
  <xsl:template match="d:divisionintro/d:titleabbrev"/>
  <xsl:template match="d:divisionintro/d:subtitle"/>
