<?xml version="1.0" encoding="ASCII"?><!--This file was created automatically by html2xhtml--><!--from the HTML stylesheets.--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" xmlns:exsl="http://exslt.org/common" xmlns:cf="http://docbook.sourceforge.net/xmlns/chunkfast/1.0" xmlns:ng="http://docbook.org/docbook-ng" xmlns:db="http://docbook.org/ns/docbook" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="exsl cf ng db d" version="1.0">
  ...
  <xsl:template match="d:set|d:book|d:part|d:preface|d:division|d:chapter|d:appendix     |d:article     |d:topic     |d:reference|d:refentry     |d:book/d:glossary|d:article/d:glossary|d:part/d:glossary     |d:book/d:bibliography|d:article/d:bibliography|d:part/d:bibliography     |d:colophon" priority="1">
   <xsl:choose>
  ...
  <xsl:template match="d:setindex     |d:book/d:index     |d:article/d:index     |d:part/d:index     |d:division/d:index" priority="1">
  ...
  <!-- ==================================================================== -->
  <xsl:template match="d:set|d:book|d:part|d:preface|d:chapter|d:appendix     |d:article     |d:topic     |d:reference|d:refentry     |d:sect1|d:sect2|d:sect3|d:sect4|d:sect5     |d:section     |d:book/d:glossary|d:article/d:glossary|d:part/d:glossary     |d:book/d:bibliography|d:article/d:bibliography|d:part/d:bibliography     |d:colophon     |d:division" mode="enumerate-files" priority="1">
  ...
  <xsl:template match="d:book/d:index|d:article/d:index|d:part/d:index|d:division/d:index" mode="enumerate-files" priority="1">
