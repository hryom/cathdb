<?xml version="1.0" encoding="ASCII"?><!--This file was created automatically by html2xhtml--><!--from the HTML stylesheets.--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook" xmlns:exsl="http://exslt.org/common" xmlns:cf="http://docbook.sourceforge.net/xmlns/chunkfast/1.0" xmlns:ng="http://docbook.org/docbook-ng" xmlns:db="http://docbook.org/ns/docbook" xmlns="http://www.w3.org/1999/xhtml" version="1.0" exclude-result-prefixes="exsl cf ng db d">
  ...
  <xsl:import href="http://docbook.sourceforge.net/release/xsl-ns/1.78.1/xhtml/chunk-common.xsl"/>
  ...
  <xsl:template name="html.head">
    ...
    <head>
      ...
      <xsl:if test="$html.extra.head.links != 0">
        <xsl:for-each select="//d:part           |//d:reference           |//d:preface           |//d:chapter           |//d:article           |//d:refentry           |//d:appendix[not(parent::d:article)]|d:appendix           |//d:glossary[not(parent::d:article)]|d:glossary           |//d:index[not(parent::d:article)]|d:index           |//d:division">
          <link rel="{local-name(.)}">
            <xsl:attribute name="href">
              <xsl:call-template name="href.target">
